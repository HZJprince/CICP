...
(function (CICP) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return CICP.LanguageList.getValue();
            };
    ...
    })(Northwind = CICP.Northwind || (CICP.Northwind = {}));
})(CICP || (CICP = {}));
var CICP;
(function (CICP) {
    var Northwind;
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new CICP.BasicProgressDialog();
...
(function (CICP) {
    ...
    (function (BasicSamples) {
        ...
        }(CICP.Common.BulkServiceAction));
        BasicSamples.OrderBulkAction = OrderBulkAction;
    })(BasicSamples = CICP.BasicSamples || (CICP.BasicSamples = {}));
})(CICP || (CICP = {}));
var CICP;
(function (CICP) {
    var Northwind;
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(CICP.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: CICP.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                CICP.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
        ...
        var MobileUserDialog = (function (_super) {
            ...
            function MobileUserDialog() {
                ...
                this.form.Password.addValidationRule(this.uniqueName, function (e) {
                    if (_this.form.Password.value.length < 6)
...
(function (CICP) {
    ...
    (function (MobileUser) {
        var MobileUserGrid = (function (_super) {
            ...
            MobileUserGrid.prototype.getDefaultSortBy = function () {
                return [MobileUser.MobileUserRow.Fields.Username];
            };
...
(function (CICP) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('CICP');
    })(ScriptInitialization = CICP.ScriptInitialization || (CICP.ScriptInitialization = {}));
})(CICP || (CICP = {}));
var CICP;
(function (CICP) {
    var Common;
...
(function (CICP) {
    ...
    })(Administration = CICP.Administration || (CICP.Administration = {}));
})(CICP || (CICP = {}));
var CICP;
(function (CICP) {
    var Administration;
...
(function (CICP) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return CICP.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = CICP.BasicSamples || (CICP.BasicSamples = {}));
})(CICP || (CICP = {}));
var CICP;
(function (CICP) {
...
(function (CICP) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'CICP.Northwind.Entities.Gender');
    })(Northwind = CICP.Northwind || (CICP.Northwind = {}));
})(CICP || (CICP = {}));
var CICP;
(function (CICP) {
...
(function (CICP) {
    ...
    CICP.BasicProgressDialog = BasicProgressDialog;
})(CICP || (CICP = {}));
var CICP;
(function (CICP) {
    var DialogUtils;
    ...
    })(DialogUtils = CICP.DialogUtils || (CICP.DialogUtils = {}));
})(CICP || (CICP = {}));
var CICP;
(function (CICP) {
    var Common;
...
(function (CICP) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = CICP.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = CICP.LanguageList || (CICP.LanguageList = {}));
})(CICP || (CICP = {}));
var CICP;
(function (CICP) {
    var Common;
...
(function (CICP) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return CICP.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return CICP.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return CICP.Northwind.SalesByCategoryService.baseUrl; };
            /**
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = CICP.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(CICP.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new CICP.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new CICP.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new CICP.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, CICP.Northwind.OrderRow.Fields.ShipCountry);
...
(function (CICP) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return CICP.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return CICP.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return CICP.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return CICP.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = CICP.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return CICP.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (CICP) {
    ...
    (function (BasicSamples) {
        ...
        }(CICP.Northwind.OrderDetailsEditor));
...
(function (CICP) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return CICP.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return CICP.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return CICP.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return CICP.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new CICP.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = CICP.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(CICP.Northwind.OrderDetailDialog));
...
(function (CICP) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return CICP.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return CICP.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return CICP.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return CICP.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return CICP.Northwind.OrderService.baseUrl; };
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: CICP.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: CICP.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new CICP.Northwind.OrderDialog();
                        ...
                        var chai = CICP.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = CICP.Northwind.EmployeeRow.getLookup().items
...
(function (CICP) {
    ...
    })(Authorization = CICP.Authorization || (CICP.Authorization = {}));
})(CICP || (CICP = {}));
var CICP;
(function (CICP) {
    var Administration;
...
//# sourceMappingURL=CICP.Web.js.map